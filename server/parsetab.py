...
_lr_productions = [
  ...
  ('functions -> FUNCTION type ID L_PAR functionsHelp R_PAR L_KEY variables statements R_KEY','functions',10,'p_functions','parser.py',43),
  ...
  ('idCall -> ID L_BRACK exp R_BRACK','idCall',4,'p_idCall','parser.py',223),
